...
function init(_rowsCount, _columnsCount) {
    ...
    for (var i = 0; i < rowsCount; ++i) {
        ...
        for (var j = 0; j < columnsCount; ++j) {
            ...
            // Указывает компьютеру, что надо производить изменение цвета плавно
            cellRect.style.transition = 'background .1s linear';
    ...
    for (var i = 0; i < rowsCount; ++i) {
        for (var j = 0; j < rowsCount; ++j) {
            /*
                ...
                например если i = 0 и j = 0, т.е она находиться в левом верхнем углу, у неё отсутсвуют следующие соседи:
